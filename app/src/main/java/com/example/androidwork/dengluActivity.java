...
import com.example.androidwork.util.ViewUtil;

public class dengluActivity extends AppCompatActivity implements  View.OnClickListener,View.OnFocusChangeListener{
    ...
    private class HideTextWatcher implements TextWatcher {
        ...
        public void afterTextChanged(Editable s) {
            ...
            if ((mStr.length() == 11 && mMaxLength == 11) ||
                ...
                ViewUtil.hideOneInputMethod(dengluActivity.this, mView);
            }
        }
    }
    // 初始化用户类型的下拉框
    private String[] typeArray = {"  个人", "  公司","  李圆丰17990043"};
